...
const ClientEngagementAgreement = () => {
  return (
    <>
      <Helmet>
        <title>Client Engagement Agreement | Professional Services Contract | HRX CPAs</title>
        <meta name="description" content="Standard client engagement agreement for HRX CPAs professional services: terms, responsibilities, fees, and service scope for tax and accounting clients." />
        <link rel="canonical" href="https://hrxcpas.com/client-engagement-agreement" />
      </Helmet>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    ...
                    <li>• Immediate for project-based work upon completion</li>
                    <li>• Payment due for all completed work</li>
                    <li>• Client files provided within 30 days</li>
                    <li>• Transition assistance as requested</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    ...
                    <li>• Scope changes beyond agreement</li>
                    <li>• 30-day notice when professionally permissible</li>
                  </ul>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8 bg-primary/5">
              ...
              <div className="space-y-6">
                <p className="text-muted-foreground">
                  By signing below or proceeding with services, both parties acknowledge they have read, 
                  understood, and agree to be bound by the terms of this engagement agreement.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h3 className="font-semibold text-foreground">Client Acceptance</h3>
                    <div className="border border-border p-4 rounded bg-white">
                      <p className="text-sm text-muted-foreground mb-2">Signature:</p>
                      <div className="border-b border-muted-foreground mb-2 h-8"></div>
                      <p className="text-sm text-muted-foreground mb-2">Printed Name:</p>
                      <div className="border-b border-muted-foreground mb-2 h-6"></div>
                      <p className="text-sm text-muted-foreground mb-2">Date:</p>
                      <div className="border-b border-muted-foreground h-6"></div>
                    </div>
                  </div>
                  
                  <div className="space-y-4">
                    <h3 className="font-semibold text-foreground">HRX CPAs</h3>
                    <div className="border border-border p-4 rounded bg-white">
                      <p className="text-sm text-muted-foreground mb-2">Hiren Parmar, CPA, CVA, CEPA</p>
                      <div className="border-b border-muted-foreground mb-2 h-8"></div>
                      <p className="text-sm text-muted-foreground mb-2">President</p>
                      <div className="border-b border-muted-foreground mb-2 h-6"></div>
                      <p className="text-sm text-muted-foreground mb-2">Date:</p>
                      <div className="border-b border-muted-foreground h-6"></div>
                    </div>
...
export default ClientEngagementAgreement;